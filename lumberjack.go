...
type Logger struct {
	...
	// BackupTimeFormat is the rotation time for creating a new filename in
	// rotating log files. If not exists, defaultBackupTimeFormat is used instead.
...
func (l *Logger) oldLogFiles() ([]logInfo, error) {
	...
	for _, f := range files {
		...
		var t time.Time
		if l.BackupTimeFormat == "" {
			t, err = time.Parse(defaultBackupTimeFormat, name)
		} else {
